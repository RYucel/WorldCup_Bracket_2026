...
export const TEAMS: Record<string, Team> = {
  ALM: {
    ...
    name: "Almanya",
    flagCode: "de",
    rating: { attack: 80, midfield: 83, defense: 81, overall: 1916 },
    stars: 5,
  ...
  PAR: {
    ...
    name: "Paraguay",
    flagCode: "py",
    rating: { attack: 74, midfield: 74, defense: 76, overall: 1815 },
    stars: 3,
  ...
  FRA: {
    ...
    name: "Fransa",
    flagCode: "fr",
    rating: { attack: 91, midfield: 91, defense: 90, overall: 2123 },
    stars: 5,
  ...
  ISV: {
    ...
    name: "İsveç",
    flagCode: "se",
    rating: { attack: 71, midfield: 71, defense: 74, overall: 1742 },
    stars: 3.5,
  ...
  GAF: {
    ...
    name: "Güney Afrika",
    flagCode: "za",
    rating: { attack: 63, midfield: 63, defense: 63, overall: 1559 },
    stars: 3,
    coach: "Hugo Broos",
    keyPlayer: "Percy Tau",
  ...
  KAN: {
    ...
    name: "Kanada",
    flagCode: "ca",
    rating: { attack: 72, midfield: 74, defense: 72, overall: 1764 },
    stars: 3.5,
    coach: "Jesse Marsch",
  ...
  HOL: {
    ...
    name: "Hollanda",
    flagCode: "nl",
    rating: { attack: 83, midfield: 83, defense: 84, overall: 1980 },
    stars: 4.5,
    coach: "Ronald Koeman",
  ...
  FAS: {
    ...
    name: "Fas",
    flagCode: "ma",
    rating: { attack: 78, midfield: 80, defense: 78, overall: 1877 },
    stars: 4,
  ...
  POR: {
    ...
    name: "Portekiz",
    flagCode: "pt",
    rating: { attack: 85, midfield: 85, defense: 86, overall: 1990 },
    stars: 4.5,
  ...
  HIR: {
    ...
    name: "Hırvatistan",
    flagCode: "hr",
    rating: { attack: 79, midfield: 80, defense: 81, overall: 1905 },
    stars: 4,
    coach: "Zlatko Dalić",
  ...
  ISP: {
    ...
    name: "İspanya",
    flagCode: "es",
    rating: { attack: 93, midfield: 93, defense: 91, overall: 2144 },
    stars: 5,
  ...
  AUT: {
    ...
    name: "Avusturya",
    flagCode: "at",
    rating: { attack: 77, midfield: 76, defense: 79, overall: 1836 },
    stars: 3.5,
    coach: "Ralf Rangnick",
  ...
  ABD: {
    ...
    name: "ABD",
    flagCode: "us",
    rating: { attack: 72, midfield: 75, defense: 74, overall: 1781 },
    stars: 3.5,
  ...
  BEL: {
    ...
    name: "Belçika",
    flagCode: "be",
    rating: { attack: 78, midfield: 78, defense: 81, overall: 1884 },
    stars: 4,
  ...
  SEN: {
    ...
    name: "Senegal",
    flagCode: "sn",
    rating: { attack: 75, midfield: 77, defense: 78, overall: 1842 },
    stars: 3.5,
    coach: "Aliou Cissé",
  ...
  BRE: {
    ...
    name: "Brezilya",
    flagCode: "br",
    rating: { attack: 86, midfield: 86, defense: 85, overall: 2009 },
    stars: 5,
  ...
  JPN: {
    ...
    name: "Japonya",
    flagCode: "jp",
    rating: { attack: 82, midfield: 82, defense: 79, overall: 1910 },
    stars: 4,
  ...
  FIL: {
    ...
    name: "Fildişi Sahili",
    flagCode: "ci",
    rating: { attack: 71, midfield: 71, defense: 72, overall: 1743 },
    stars: 3.5,
    coach: "Emerse Faé",
  ...
  NOR: {
    ...
    name: "Norveç",
    flagCode: "no",
    rating: { attack: 82, midfield: 81, defense: 79, overall: 1918 },
    stars: 3.5,
  ...
  MEK: {
    ...
    name: "Meksika",
    flagCode: "mx",
    rating: { attack: 81, midfield: 82, defense: 81, overall: 1912 },
    stars: 3.5,
  ...
  EKV: {
    ...
    name: "Ekvador",
    flagCode: "ec",
    rating: { attack: 80, midfield: 80, defense: 79, overall: 1902 },
    stars: 3.5,
  ...
  ING: {
    ...
    name: "İngiltere",
    flagCode: "gb-eng",
    rating: { attack: 86, midfield: 87, defense: 86, overall: 2038 },
    stars: 5,
    coach: "Thomas Tuchel",
  ...
  ARJ: {
    ...
    name: "Arjantin",
    flagCode: "ar",
    rating: { attack: 94, midfield: 91, defense: 92, overall: 2148 },
    stars: 5,
  ...
  KAP: {
    ...
    name: "Yeşil Burun",
    flagCode: "cv",
    rating: { attack: 65, midfield: 67, defense: 66, overall: 1622 },
    stars: 3,
    coach: "Bubista",
  ...
  AUS: {
    ...
    name: "Avustralya",
    flagCode: "au",
    rating: { attack: 76, midfield: 76, defense: 74, overall: 1800 },
    stars: 3,
    coach: "Tony Popovic",
  ...
  MIS: {
    ...
    name: "Mısır",
    flagCode: "eg",
    rating: { attack: 71, midfield: 72, defense: 72, overall: 1742 },
    stars: 3.5,
    coach: "Hossam Hassan",
  ...
  ISVR: {
    ...
    name: "İsviçre",
    flagCode: "ch",
    rating: { attack: 81, midfield: 82, defense: 81, overall: 1914 },
    stars: 4,
    coach: "Murat Yakın",
  ...
  CEZ: {
    ...
    name: "Cezayir",
    flagCode: "dz",
    rating: { attack: 72, midfield: 76, defense: 75, overall: 1785 },
    stars: 3.5,
  ...
  KOL: {
    ...
    name: "Kolombiya",
    flagCode: "co",
    rating: { attack: 84, midfield: 85, defense: 86, overall: 2004 },
    stars: 4,
  ...
  GAN: {
    ...
    name: "Gana",
    flagCode: "gh",
    rating: { attack: 63, midfield: 63, defense: 62, overall: 1575 },
    stars: 3,
    coach: "Otto Addo",
